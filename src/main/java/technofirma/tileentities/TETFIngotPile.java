...
public class TETFIngotPile extends NetworkTileEntity implements IInventory
{
	...
	public TETFIngotPile()
	{
		...
		type = "ThaumicSteel";
		INGOTS = new Item[] { TechnofirmaCore.ThaumicSteelIngot };
	}
	...
	public void updateNeighbours()
	{
		if(worldObj.blockExists(xCoord, yCoord+1, zCoord) && !worldObj.isAirBlock(xCoord, yCoord+1, zCoord))
			worldObj.getBlock(xCoord, yCoord+1, zCoord).onNeighborBlockChange(worldObj, xCoord, yCoord+1, zCoord, TechnofirmaCore.TFIngotPile);
	}
