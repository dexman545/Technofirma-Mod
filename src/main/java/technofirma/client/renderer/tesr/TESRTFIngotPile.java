...
public class TESRTFIngotPile extends TESRBase
{
	...
	public void renderTileEntityIngotPileAt(TETFIngotPile tep, double d, double d1, double d2, float f)
	{
		...
		if (tep.getWorldObj() != null && tep.getStackInSlot(0) != null && block == TechnofirmaCore.TFIngotPile)
		{
			int i = ((BlockTFIngotPile) block).getStack(tep.getWorldObj(), tep);
			TFC_Core.bindTexture(new ResourceLocation("technofirma", Icon)); //texture
